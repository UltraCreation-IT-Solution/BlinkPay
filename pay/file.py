...
from blynkpay.settings import AWS_ACCESS_KEY_ID,AWS_SECRET_ACCESS_KEY,AWS_STORAGE_BUCKET_NAME,REGION_NAME
...
def upload(file, filetype, name):
    ...
    if file_ext == "":
        file_ext = 'png'
    filename = "KHEBRAH-{}-{}{}{}{}{}{}{}{}".format(filetype, today.year, today.month, today.day, today.hour, today.minute, today.second, today.microsecond, file_ext)
